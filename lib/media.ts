 ...
 */
export const PHOTOS = {
  hero: { src: '/photos/knights-tale-wide.jpg', alt: 'The Knight’s Tale — a bright, empty meeting room at The Quarter, sunlight pouring across the table' },
  heroMeeting: { src: '/photos/hero-chapter-house.jpg', alt: 'A meeting in The Chapter House, Canterbury Cathedral’s rooftops in the window' },
  ...
  cafe: { src: '/photos/cafe.jpg', alt: 'The Kentish Pantry — cakes and treats by the window, herbs and the cathedral beyond' },
  ...
  meetingWindow: { src: '/photos/chapter-house-wide.jpg', alt: 'The Chapter House — the round meeting table, oak-slat wall and the Cathedral Quarter rooftops through the window' },
  // Round-4 additions
  urbanFarm: { src: '/photos/urban-farm.jpg', alt: 'Our Auk Smart Garden — herbs growing on the café windowsill, cathedral rooftops beyond' },
  coffeeMachine: { src: '/photos/coffee-machine.jpg', alt: 'The bean-to-cup coffee machine, syrups and cold drinks in The Kentish Pantry' },
