...
export const SITE = {
  ...
  description:
    "A boutique co-working home above Canterbury's Cathedral Quarter. Come for the warmth, the natural light and the breakfast — find your focus, and an escape from home.",
